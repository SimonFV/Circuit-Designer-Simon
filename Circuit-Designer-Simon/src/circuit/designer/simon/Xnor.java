...
public class Xnor extends Gate{
    public Xnor(Pane target, double x, double y, CircuitList circuit) {
        ...
        this.gselected = GateFigure.construct("XNORSELECTED");
    }
    
    @Override
    public void constructFigure(){
        
        this.g.getChildren().add(GateFigure.construct("XNOR"));
