...
public class Nor extends Gate{
    public Nor(Pane target, double x, double y, CircuitList circuit) {
        ...
        this.gselected = GateFigure.construct("NORSELECTED");
    }
    
    @Override
    public void constructFigure(){
        
        this.g.getChildren().add(GateFigure.construct("NOR"));
