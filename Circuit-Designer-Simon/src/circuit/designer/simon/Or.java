...
public class Or extends Gate {
    //Constructor
    public Or(Pane target, double x, double y, CircuitList circuit) {
        ...
        this.gselected = GateFigure.construct("ORSELECTED");
    }
    
    @Override
    public void constructFigure(){
        
        this.g.getChildren().add(GateFigure.construct("OR"));
