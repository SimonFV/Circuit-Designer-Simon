...
public class Xor extends Gate{
    public Xor(Pane target, double x, double y, CircuitList circuit) {
        ...
        this.gselected = GateFigure.construct("XORSELECTED");
    }
    
    @Override
    public void constructFigure(){
        
        this.g.getChildren().add(GateFigure.construct("XOR"));
